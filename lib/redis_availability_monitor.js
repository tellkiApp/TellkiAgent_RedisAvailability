 ...
 * 
 * EXAMPLE: node redis_availability_monitor.js "1,1,1,1" "10.10.2.5" "6379" "password"
 *
 * README:
 ...
 */
var metrics = [];
metrics['Status']		= { id: '1390:Status:9' };
metrics['ResponseTime']	= { id: '1391:Response Time:4' };
metrics['Role']			= { id: '1392:Role:9', 			key : 'role' };
metrics['Uptime']		= { id: '1393:Uptime:4', 		key : 'uptime_in_seconds' };
